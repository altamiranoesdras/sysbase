...
<a href="{{ route('rols.show', $id) }}" class='btn btn-default btn-sm' data-toggle="tooltip" title="Ver">
    <i class="fa fa-eye"></i>
</a>

<a href="{{ route('rols.edit', $id) }}" class='btn btn-info btn-sm' data-toggle="tooltip" title="Editar">
